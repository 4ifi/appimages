...
curl --retry 9999 --retry-delay 3 --speed-time 10 --retry-max-time 0 -C - -A "Linux x86_64" -L https://sourceforge.net/projects/supertuxkart/files/latest/download -o data.tar.xz
tar -xvf data.tar.xz
rm data.tar.xz
mv * AppDir
cd AppDir
